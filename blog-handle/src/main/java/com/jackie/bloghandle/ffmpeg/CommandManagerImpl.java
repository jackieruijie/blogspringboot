...
import com.jackie.bloghandle.ffmpeg.commandbuidler.CommandAssemblyImpl;
...
import com.jackie.bloghandle.ffmpeg.data.TaskDaoImpl;
import com.jackie.bloghandle.ffmpeg.handler.*;
...
public class CommandManagerImpl implements CommandManager {
        ...
        if (id != null && command != null) {
            ...
            if (tasker != null) {
                ...
                if (ret > 0) {
                    ...
                    if (config.isDebug()) System.err.println("持久化失败，停止任务！");
                    return "持久化失败，停止任务！";
                }
            }
        }
    ...
    public String start(Map<String, String> assembly) {
        ...
        String appName = assembly.get("appName");//获取执行代码的标识符
