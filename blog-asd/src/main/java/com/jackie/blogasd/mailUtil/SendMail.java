...
public class SendMail {
    //账户和密码
    public final static String MY_EMAIL_ACCOUNT = "qingyu_7ust@foxmail.com";
    public final static String MY_EMAIL_PASSWORD = "lzepohkxmlbeciea";
    //指定smtp服务器
     ...
     * @return
     */
    public static void sendEmail2User(String userEmail) throws MessagingException {
        ...
        // 3. 创建一封邮件
        MimeMessage message = createMimeMessage(session, MY_EMAIL_ACCOUNT, userEmail);
    ...
    private static MimeMessage createMimeMessage(Session session, String myEmailAccount, String userEmail) {
